...
public class Teste_Inclusão_RegistroDeVenda {
	...
	@Test(expected = RuntimeException.class)
	public void CTRVI16() {
		RV = new RegistroVenda("4;Arroz;37413815869;10/00/2015;0;7.00;1;5.00;");		
	}
	/*ESTA DANDO ERRO FAVOR COMENTAR A FUNCIONALIDADE*/
	@Test()
	public void CTRVI17() {
		RV = new RegistroVenda("5;Arroz;37413815869;10/01/2015;0;7.00;1;5.00;");
	...
	@Test()
	public void CTRVI18() {
		RV = new RegistroVenda("6;Arroz;37413815869;10/12/2015;0;7.00;1;5.00;");
	...
	@Test(expected = RuntimeException.class)
	public void CTRVI22() {
		RV = new RegistroVenda("9;Arroz;37413815869;09/06/2015;0.01;");		
	}
	...
	@Test(expected = RuntimeException.class)
	public void CTRVI23() {
		RV = new RegistroVenda("10;Arroz;37413815869;09/06/2015;7.00;5.00;");		
	}
